...
Its main Raison d'être is supporting the very nice "Robotlegs":http://github.com/robotlegs/robotlegs-framework AS3 MCVS framework by "Shaun Smith":http://shaun.boyblack.co.za/blog/ - hence the name.
